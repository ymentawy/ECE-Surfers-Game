...
#define BOOSTERPACK_JS_HORIZONTAL_PORT GPIO_PORT_P6
#define BOOSTERPACK_JS_HORIZONTAL_PIN GPIO_PIN0

#define BOOSTERPACK_JS_VERTICAL_PORT GPIO_PORT_P4
#define BOOSTERPACK_JS_VERTICAL_PIN GPIO_PIN4

#define BOOSTERPACK_JS_PERIPHERAL_MODULE GPIO_TERTIARY_MODULE_FUNCTION
